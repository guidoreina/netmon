#ifndef NET_MON_IPV6_TCP_CONNECTION_H
#define NET_MON_IPV6_TCP_CONNECTION_H
      ...
      namespace tcp {
        class connection : public net::mon::tcp::connection {
          public:
            ...
            // Constructor.
            connection() = default;
            connection(const struct in6_addr& addr1,
                       in_port_t port1,
                       const struct in6_addr& addr2,
                       in_port_t port2);

            // Assign.
            void assign(const struct in6_addr& addr1,
                        in_port_t port1,
                        const struct in6_addr& addr2,
                        in_port_t port2);
        ...
        inline connection::connection(const struct in6_addr& addr1,
                                      in_port_t port1,
                                      const struct in6_addr& addr2,
                                      in_port_t port2)
        {
        ...
        inline void connection::assign(const struct in6_addr& addr1,
                                       in_port_t port1,
                                       const struct in6_addr& addr2,
                                       in_port_t port2)
        {
...
#endif // NET_MON_IPV6_TCP_CONNECTION_H
